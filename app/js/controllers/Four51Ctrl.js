four51.app.controller('Four51Ctrl', ['$scope', '$route', '$location', '$451', 'User', 'SpendingAccount', 'Order', 'Security', 'OrderConfig', 'Category', 'AppConst',
    function ($scope, $route, $location, $451, User, SpendingAccount, Order, Security, OrderConfig, Category, AppConst) {
        ...
        function init() {
            if (Security.isAuthenticated()) {
                ...
                $scope.slides = [
                    {image:'http://digitalisis.com/banner-2000w.jpg'},
